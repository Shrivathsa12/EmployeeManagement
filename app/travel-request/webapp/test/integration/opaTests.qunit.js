...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "travelrequest/test/integration/FirstJourney",
    "travelrequest/test/integration/TravelRequestsListJourney",
    "travelrequest/test/integration/TravelRequestsObjectPageJourney",
    "travelrequest/test/integration/TravelDocumentsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
